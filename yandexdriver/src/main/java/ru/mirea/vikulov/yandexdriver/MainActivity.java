package ru.mirea.vikulov.yandexdriver;
...
import ru.mirea.vikulov.yandexdriver.databinding.ActivityMainBinding;

public class MainActivity extends AppCompatActivity implements DrivingSession.DrivingRouteListener {

    private ActivityMainBinding binding;
    private final String MAPKIT_API_KEY = "493118b9-6b0e-4df3-ad16-877e1b057f76";
    private final Point ROUTE_START_LOCATION = new Point(55.670005, 37.479894);
    private final Point ROUTE_END_LOCATION = new Point(55.720418, 37.378791);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int posPermissionStatus1 = ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION);
        int posPermissionStatus2 = ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION);
...
// Ининциализируем объект для создания маршрута водителя
        ...
        PlacemarkMapObject marker = mapView.getMap().getMapObjects().addPlacemark(new Point(55.720418, 37.378791),
                ImageProvider.fromResource(this,R.drawable.shop));
        marker.addTapListener(new MapObjectTapListener() {
            @Override
            public boolean onMapObjectTap(@NonNull MapObject mapObject, @NonNull Point
                    point) {
                Toast.makeText(getApplication(),"Vegas \n" + "Время работы с 10:00 до 22:00",
