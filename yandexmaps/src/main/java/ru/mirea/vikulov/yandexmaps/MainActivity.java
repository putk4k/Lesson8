package ru.mirea.vikulov.yandexmaps;
...
import ru.mirea.vikulov.yandexmaps.databinding.ActivityMainBinding;
...
// При получении координат местоположения устанавливается следующая иконка
        ...
        pinIcon.setIcon(
                "pin",
                ImageProvider.fromResource(this, R.drawable.point_mp),
